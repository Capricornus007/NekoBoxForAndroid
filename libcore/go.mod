...
require (
	...
	github.com/amnezia-vpn/amneziawg-go/v3 v3.0.3 // indirect
...
// sing-quic: 1.14.x rebase — SagerNet の v0.6.4 (realm PortMapping 含む) を使用。
// hawkff 版は古く realm portmap が無く、sing-box 1.14.x の hysteria2 がコンパイルできない。
