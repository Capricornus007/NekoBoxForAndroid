...
constructor(
    ...
    init {
        widgetLayoutResource = R.layout.preference_widget_add_button
    ...
    var onExtraLinksClick: (() -> Unit)? = null

    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        super.onBindViewHolder(holder)
        val addButton = holder.findViewById(R.id.add_button) as? android.view.View
        addButton?.setOnClickListener {
            onExtraLinksClick?.invoke()
        }
    }
}